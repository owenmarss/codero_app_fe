...
import imageTest from "/public/images/test2.jpg";

export default async function RoboticSessionByID({
    params,
}: {
    ...
    return (
        <main className="pt-7 pb-10 px-6 flex flex-col gap-5">
            ...
            <div id="session_robotic_content">
            ...
            <div id="session_robotic_link" className="flex justify-between pt-5">
                <div id="session_robotic_link_source" className="flex flex-col">
                ...
                <div id="session_robotic_link_video" className="flex flex-col">
                    <h1 className="font-semibold"> Link video: </h1>
                    {data?.link_video ? (
