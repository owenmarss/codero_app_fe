            ...
            <div id="resources_content" className="flex flex-col gap-5">
                    ...
                    <div id="resources_coding_content_container" className="flex gap-5 pb-5 overflow-x-scroll whitespace-nowrap">
                        <div id="resources_coding_content" className="flex flex-col w-72 pt-3 pb-7 px-4 gap-6 border-2 border-primary rounded-lg shadow-lg drop-shadow-2xl">
                            <div id="resources_coding_content_text" className="flex flex-col">
                                ...
                                <h2 className="text-primary font-medium text-lg italic"> Scratch </h2>
                                <h3 className="text-gray-600 font-light text-md"> xx Week </h3>
                            </div>
                ...
                <div id="resources_robotic_container" className="flex flex-col gap-1.5">
                    ...
                    <div id="resources_robotic_content_container" className="flex gap-5 pb-5 overflow-x-scroll whitespace-nowrap">
                        <div id="resources_robotic_content" className="flex flex-col w-72 pt-3 pb-7 px-4 gap-6 border-2 border-primary rounded-lg shadow-lg drop-shadow-2xl">
                            <div id="resources_robotic_content_text" className="flex flex-col">
                                <h1 className="text-black font-semibold text-xl"> U-Kit Tinny Semester 1 </h1>
                                <h2 className="text-primary font-medium text-lg italic"> U-Kit </h2>
                                <h3 className="text-gray-600 font-light text-md"> xx Week </h3>
                            </div>
