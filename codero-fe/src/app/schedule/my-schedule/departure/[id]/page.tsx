...
import DepartureForm from "@/components/forms/departure-form";
...
export default async function DeparturePage({
    ...
    return (
        <main id="departure" className="pt-7 pb-10 px-6 flex flex-col gap-5">
            <div id="departure_title">
                <h1 className="text-2xl font-bold text-primary tracking-wide">
                    Departure
                </h1>
            </div>

            {data.departure_status == "Belum Isi" && (
                <div
                    id="departure_schedule_detail_container"
                    className="flex justify-between"
                >
                    <div
                        id="departure_schedule_detail_left"
                        className="flex flex-col gap-3"
                    >
                        <div
                            id="departure_schedule_detail_name"
                        ...
                        <div
                            id="departure_schedule_detail_date"
                            className="flex flex-col"
                        >
                        ...
                        <div
                            id="departure_schedule_detail_time"
                            className="flex flex-col"
                        >
                    ...
                    <div
                        id="departure_schedule_detail_right"
                        className="flex flex-col gap-3"
                    >
                        <div
                            id="departure_schedule_detail_session"
                            className="flex flex-col"
                        >
                        ...
                        {data.userTeachingSchedule.teachingSchedule.session_type == "Onsite" && (
                            <div
                                id="departure_schedule_detail_location"
                                className="flex flex-col"
                            >
                        ...
                        <div id="departure_schedule_detail_curriculum">
            ...
            {data.departure_status == "Belum Isi" && (
                <div className="flex justify-center">
                    <DepartureForm scheduleId={id} />
                </div>
            )}

            {data.departure_status == "Sudah Isi" && (
                <div id="departure_note">
